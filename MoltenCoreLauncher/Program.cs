...
class Launcher
{
    private const string LEGACY_CONFIG_FILE_NAME = "classic.json";
    private const string CONFIG_FILE_NAME = "launcher-config.json";
    ...
    private static void PrintLogo()
    {
        ...
        Console.WriteLine("https://github.com/EverCore/MoltenCoreLauncher");
        Console.WriteLine("");
        ...
        Console.WriteLine("       .,,,,,..        .,,");
        Console.WriteLine("     ,,,,,    ....       ,,,");
        WriteWithASubtext("    .,,,.  ,,,,,,,,,,,    ,,,", "       熔火之心");
        WriteWithASubtext("    ,,,,. .,,,,   ,,,,.   ,,,,", "      经典旧世");
        Console.WriteLine("    .,,,,         ,,,,.   ,,,,");
        WriteWithASubtext("     ,,,,,,,...,,,,,,,   ,,,,.", "      公平公正");
        WriteWithASubtext("       ,,,,,,,,,,,..   .,,,,,", "       自由交易");
        WriteWithASubtext("   ,.        .       .,,,,,,", "     QQ群:615247564");
        Console.WriteLine("     ,,,..      ..,,,,,,,.");
        Console.WriteLine("       .,,,,,,,,,,,,,,,");
